...
{
    public partial class ctrlAddEditJourney : BaseForms.BaseControl
    {
        ICustomerService customerService;
        JourneyModel currentData;
        public ctrlAddEditJourney()
        {
            InitializeComponent();
        ...
        public override object GetFieldValues()
        {
            ...
            JourneyModel model = new JourneyModel { CustomerId = customerId, Journey = txtJourney.Text, Base = Convert.ToDecimal(txtBase.Text), ID = currentData.ID };
            return model;
        }
