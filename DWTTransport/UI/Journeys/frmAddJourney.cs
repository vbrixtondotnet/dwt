...
{
    public partial class frmAddJourney : BaseDialogFormSmall
    {

        private ICustomerService _customerService;
        private IJourneyService _journeyService;
        private ctrlAddEditJourney currentControl;
        public frmAddJourney() : base("Add/Edit Customer")
        {
            _customerService = new CustomerService() as ICustomerService;
            _journeyService = new JourneyService() as IJourneyService;
            currentControl = new ctrlAddEditJourney();
